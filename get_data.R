...
if(!FALSE){
  ...
  write.csv(whole, paste(dataframe_folder, '/', '2009_earlier.csv', sep=''))
  
  #2008 Comparison
  start <- as.character("2008-08-24")
  end   <- as.character("2008-09-21")
  whole <- build_spatial_multistation_df(freeways, start, end, c("flow","occ","speed","del_60"), base.url = base.url)
  
  write.csv(whole, paste(dataframe_folder, '/', '2008_earlier.csv', sep=''))
